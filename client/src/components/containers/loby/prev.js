                  ...
                  <div className="game">
                    <div className="">
                      <div className="cash-game-icon-container">
                        <div className="cash-game-icon-wrapper" style={{backgroundImage: `url(${cashGameIcon})`}}></div>
                      </div>
                    </div>
                    <div className="">
                  ...
                  <div className="game">
                    <div className="">
                      <div className="tournament-icon-container">
                        <div className="cash-game-icon-wrapper" style={{backgroundImage: `url(${TournamentIcon})`}}></div>
                      </div>
                    </div>
                    <div className="">
                      <div className="game-box">
                  ...
                  <div className="game">
                    <div className="">
                      <div className="sit-go-game-icon-container">
                        <div className="cash-game-icon-wrapper" style={{backgroundImage: `url(${SitGoIcon})`}}></div>
                      </div>
                    </div>
                    <div className="">
                      <div className="game-box">
                  ...
                  <div className="game">
                    <div className="">
                      <div className="my-tournament-icon-container">
                        <div className="cash-game-icon-wrapper" style={{backgroundImage: `url(${MyTournamentIcon})`}}></div>
                      </div>
                    </div>
                    <div className="">
                      <div className="game-box">
